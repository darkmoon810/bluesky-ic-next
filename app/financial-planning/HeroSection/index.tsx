        ...
        <div className="flex-col items-center flex max-w-screen-xl px-8 py-0 relative w-full flex-[0_0_auto]">
          <div className="flex-col items-center gap-12 pt-24 pb-48 px-4 md:px-8 self-stretch w-full flex-[0_0_auto] bg-[#52379e] rounded-2xl overflow-hidden flex relative">
            ...
            <div className="flex flex-col items-center gap-8 relative z-[2]">
              ...
              >
                <h1 className="w-full md:w-[900px] [font-family:'DM_Serif_Text',Helvetica] font-normal text-[#ffffff] text-[40px] md:text-[64px] text-center tracking-[-1.28px] leading-[1.1] md:leading-[72px]">
                  Your trusted financial planning advisors
                </h1>
                <p className="text-white text-lg md:text-xl text-center leading-[1.6] md:leading-[30px] relative max-w-[800px]">
                Our pride lies in delivering tailored financial planning considering your needs, goals, and challenges.
                </p>
              </motion.div>
            </div>
              ...
              {backgroundImages.map((_, index) => (
                <motion.div
                  ...
                  className={`relative w-2 h-2 rounded-full cursor-pointer ${
                    index === currentImageIndex ? 'bg-[#00359e]' : 'bg-[#eaecf0]'
                  }`}
